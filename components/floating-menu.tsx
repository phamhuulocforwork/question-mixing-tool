  ...
  return (
    <div className='pointer-events-none fixed inset-x-0 bottom-0 z-30 flex  overflow-hidden px-2 pb-1 duration-300 animate-in slide-in-from-bottom-12 lg:justify-center lg:p-4 lg:pb-4'>
      <div className='flex w-full flex-col items-center gap-2'>
        <div className='pointer-events-auto relative mx-auto flex flex-shrink-1 items-center gap-2 rounded-md border border-accent justify-center bg-accent/40 p-2 shadow-md backdrop-blur-sm scrollbar-thin max-lg:overflow-x-auto max-sm:w-full'>
